...
class SummaryState extends WindowState
{
  override public function create() : Void
  {
    ...
    addText(["It is ruled by ", Reg.resources[0].name, ", ", EnumStringer.resourceNatureVerbose(Reg.resources[0].nature), "."], [null, models.Resource.formatForNature(Reg.resources[0].nature), null, null, null]);
    ...
    if (Reg.cult != null) {
      ...
      addText(["You aren't associated with any cult."]);
    }
    addText([""]);
    addText(["You're also at the botton of the social ladder."]);
    ...
    add(new BraveButton(Lib.current.stage.stageWidth - 268.0 - 26.0, Lib.current.stage.stageHeight - 50.0, "Let's go", play));
  }
